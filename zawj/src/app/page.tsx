  ...
  return (
    <div>
      ...
      <nav className="fixed w-full z-50 px-2 sm:px-4 md:px-6 py-3 md:py-4">
        <div className="max-w-7xl mx-auto bg-white/95 backdrop-blur-xl border border-gray-200 rounded-full px-3 sm:px-4 md:px-8 py-3 md:py-4 flex justify-between items-center shadow-xl">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-red-600 to-red-600 rounded-lg flex items-center justify-center text-white font-black text-lg sm:text-xl">N</div>
          ...
          <div className="hidden lg:flex space-x-8 font-bold text-[10px] uppercase tracking-[0.2em] text-gray-600">
            <a href="#concept" className="hover:text-red-600 transition-colors">Concept</a>
            <a href="#how-to-use" className="hover:text-red-600 transition-colors">Comment utiliser</a>
            <a href="#Tuteur" className="hover:text-red-600 transition-colors">Tuteur</a>
          </div>

          {/* Boutons */}
          <div className="flex items-center gap-2">
            <Link href="/login" className="hidden sm:flex bg-gradient-to-r from-red-600 to-red-600 hover:opacity-90 text-white px-3 sm:px-4 md:px-6 py-2 rounded-full text-[10px] md:text-xs font-black uppercase transition-all">
              Connexion
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden mt-2 mx-2 sm:mx-4 bg-white/95 backdrop-blur-xl border border-gray-200 rounded-2xl shadow-xl overflow-hidden">
            <div className="flex flex-col">
              ...
              <Link href="/login" className="sm:hidden px-6 py-4 hover:bg-gray-50 transition-colors font-semibold text-red-600">
                Connexion
              </Link>
            </div>
          </div>
      ...
      <header className="relative min-h-screen flex items-center pt-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div data-aos="fade-right" data-aos-duration="1000">
            <div className="inline-block border border-[#dc2626] px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest text-[#dc2626] mb-6">
              Mariage Halal • Premium • Sécurisé
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-none mb-8 text-white">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-500">L&apos;union</span> <br />
          ...
          <div className="relative flex justify-center" data-aos="zoom-in" data-aos-duration="1200">
            <div className="relative z-10 floating">
              <div className="bg-[#1a1a1a] p-2 sm:p-3 rounded-[3rem] shadow-[0_0_50px_rgba(255,0,127,0.3)] border border-[#dc2626]/30">
                  ...
                  <div className="px-4">
                    <div className="h-80 bg-gray-900 rounded-3xl relative overflow-hidden group">
                      ...
                      <div className="absolute bottom-4 left-4">
                        ...
                        <p className="text-[#dc2626] text-xs font-bold">Bruxelles • Entrepreneur</p>
                      </div>
            ...
            {/* Elements Neon */}
            <div className="absolute -top-10 -right-10 w-32 h-32 bg-[#dc2626]/20 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-10 -left-10 w-48 h-48 bg-[#dc2626]/10 rounded-full blur-3xl"></div>
          </div>
        </div>
      </header>
      ...
      <section id="how-to-use" className="py-16 sm:py-32 relative overflow-hidden bg-gradient-to-b from-gray-50 via-white to-gray-50">
        {/* Background Effects */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-red-50/50 rounded-full blur-[120px]"></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          {/* Header */}
          <div className="text-center mb-20" data-aos="fade-up">
            <div className="inline-block border border-red-300 bg-red-50 px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.3em] text-red-600 mb-6">
              Guide Complet
            </div>
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-bold mb-6 text-gray-900">
              Comment utiliser <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-purple-600">Nissfi</span> en 4 étapes
            </h2>
          ...
          <div className="relative">
            {/* Connecting Line */}
            <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-red-200 via-red-600 to-red-200 -translate-x-1/2"></div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 mb-24" data-aos="fade-right" data-aos-duration="1000">
              <div className="lg:text-right lg:pr-16 flex flex-col justify-center">
                <div className="inline-block lg:ml-auto bg-red-50 border border-red-300 px-4 py-1 rounded-full text-xs font-black text-red-700 mb-4 w-fit">
                  ÉTAPE 01
                </div>
              ...
              <div className="relative">
                <div className="bg-white p-8 rounded-3xl border-2 border-red-300 relative overflow-hidden group hover:border-red-600 hover:shadow-xl transition-all duration-500">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-red-50 rounded-full -translate-y-16 translate-x-16 group-hover:scale-150 transition-transform duration-500"></div>
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-red-600 to-red-700 rounded-2xl flex items-center justify-center text-white text-3xl font-black mb-6 shadow-lg shadow-red-600/20">
                      1
                    </div>
                ...
                {/* Center Dot */}
                <div className="hidden lg:block absolute right-0 top-1/2 translate-x-1/2 -translate-y-1/2 w-6 h-6 bg-red-600 rounded-full border-4 border-white shadow-lg shadow-red-600/20"></div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 mb-24" data-aos="fade-left" data-aos-duration="1000">
              <div className="lg:order-2 flex flex-col justify-center">
                <div className="inline-block bg-red-50 border border-red-300 px-4 py-1 rounded-full text-xs font-black text-red-700 mb-4 w-fit">
                  ÉTAPE 02
                </div>
                <h3 className="text-3xl font-bold mb-4 text-gray-900">
              ...
              <div className="lg:order-1 relative">
                <div className="bg-white p-8 rounded-3xl border-2 border-red-300 relative overflow-hidden group hover:border-red-600 hover:shadow-xl transition-all duration-500">
                  <div className="absolute top-0 left-0 w-32 h-32 bg-red-50 rounded-full -translate-y-16 -translate-x-16 group-hover:scale-150 transition-transform duration-500"></div>
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-red-600 to-red-700 rounded-2xl flex items-center justify-center text-white text-3xl font-black mb-6 shadow-lg shadow-red-600/20">
                      2
                    </div>
                    <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs text-red-600 font-bold">99% Compatible</span>
                      </div>
                      <div className="space-y-3">
                        {[1, 2, 3].map((i) => (
                ...
                {/* Center Dot */}
                <div className="hidden lg:block absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 w-6 h-6 bg-[#dc2626] rounded-full border-4 border-black shadow-lg shadow-[#dc2626]/50"></div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 mb-24" data-aos="fade-right" data-aos-duration="1000">
              <div className="lg:text-right lg:pr-16 flex flex-col justify-center">
                <div className="inline-block lg:ml-auto bg-[#dc2626]/10 border border-[#dc2626]/30 px-4 py-1 rounded-full text-xs font-black text-[#dc2626] mb-4 w-fit">
                  ÉTAPE 03
                </div>
                <h3 className="text-3xl font-bold mb-4 text-gray-900">
              ...
              <div className="relative">
                <div className="glass-card p-8 rounded-3xl border-2 border-[#dc2626]/30 relative overflow-hidden group hover:border-[#dc2626] transition-all duration-500">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#dc2626]/10 rounded-full -translate-y-16 translate-x-16 group-hover:scale-150 transition-transform duration-500"></div>
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#dc2626] to-red-700 rounded-2xl flex items-center justify-center text-white text-3xl font-black mb-6 shadow-lg shadow-[#dc2626]/50">
                      3
                    </div>
                ...
                {/* Center Dot */}
                <div className="hidden lg:block absolute right-0 top-1/2 translate-x-1/2 -translate-y-1/2 w-6 h-6 bg-[#dc2626] rounded-full border-4 border-black shadow-lg shadow-[#dc2626]/50"></div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12" data-aos="fade-left" data-aos-duration="1000">
              <div className="lg:order-2 flex flex-col justify-center">
                <div className="inline-block bg-[#dc2626]/10 border border-[#dc2626]/30 px-4 py-1 rounded-full text-xs font-black text-[#dc2626] mb-4 w-fit">
                  ÉTAPE 04
                </div>
                <h3 className="text-3xl font-bold mb-4 text-gray-900">
                  Échange & Mariage
              ...
              <div className="lg:order-1 relative">
                <div className="glass-card p-8 rounded-3xl border-2 border-[#dc2626]/30 relative overflow-hidden group hover:border-[#dc2626] transition-all duration-500">
                  <div className="absolute top-0 left-0 w-32 h-32 bg-[#dc2626]/10 rounded-full -translate-y-16 -translate-x-16 group-hover:scale-150 transition-transform duration-500"></div>
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#dc2626] to-red-700 rounded-2xl flex items-center justify-center text-white text-3xl font-black mb-6 shadow-lg shadow-[#dc2626]/50">
                      4
                    </div>
                    <div className="space-y-4">
                      <div className="bg-slate-900/50 rounded-2xl p-4 border border-slate-700/50">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-2">
                            <div className="w-6 h-6 rounded-full bg-[#dc2626]/20 border-2 border-[#dc2626] flex items-center justify-center animate-pulse">
                      ...
                      <div className="text-center py-4 px-6 bg-gradient-to-r from-[#dc2626] to-red-700 rounded-xl">
          ...
          <div className="text-center mt-20" data-aos="zoom-in" data-aos-delay="200">
            <Link 
              href="/register"
              className="inline-flex items-center gap-3 bg-gradient-to-r from-[#dc2626] to-red-700 px-12 py-6 rounded-2xl text-white font-black uppercase tracking-widest hover:shadow-2xl hover:shadow-[#dc2626]/50 transition-all duration-300 group"
            >
      ...
      <section id="concept" className="py-16 sm:py-32 bg-gradient-to-b from-white via-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 sm:mb-24" data-aos="fade-up">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-gray-900">L&apos;ADN <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-purple-600">Nissfi</span></h2>
            <div className="w-20 h-1 bg-gradient-to-r from-red-600 to-purple-600 mx-auto"></div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-12">
            <div className="bg-white p-6 sm:p-10 rounded-[2rem] border-2 border-gray-200 hover:border-red-600 hover:shadow-xl transition-all group" data-aos="fade-up">
              <div className="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center text-red-600 text-2xl mb-8 group-hover:bg-red-600 group-hover:text-white transition-all">
            ...
            <div className="bg-white p-10 rounded-[2rem] border-2 border-gray-200 hover:border-red-600 hover:shadow-xl transition-all group" data-aos="fade-up" data-aos-delay="100">
              <div className="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center text-red-600 text-2xl mb-8 group-hover:bg-red-600 group-hover:text-white transition-all">
            ...
            <div className="bg-white p-10 rounded-[2rem] border-2 border-gray-200 hover:border-red-600 hover:shadow-xl transition-all group" data-aos="fade-up" data-aos-delay="200">
              <div className="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center text-red-600 text-2xl mb-8 group-hover:bg-red-600 group-hover:text-white transition-all">
      ...
      <section id="Tuteur" className="py-16 sm:py-32 relative overflow-hidden bg-gradient-to-b from-white via-gray-50 to-white">
        ...
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-red-50/50 rounded-full blur-[150px]"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="text-center mb-12 sm:mb-20" data-aos="fade-up">
            ...
            <h2 className="text-5xl lg:text-6xl font-bold mb-6 text-gray-900">
              Le système <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-red-600 to-red-700">Tuteur</span>
              <br />révolutionnaire
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div data-aos="fade-left" data-aos-duration="1000">
              <div className="relative">
                ...
                <div className="bg-white p-8 rounded-3xl border-2 border-purple-300 relative overflow-hidden hover:shadow-xl transition-all">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-8">
                      <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-red-700 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/30">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-purple-50 border border-purple-300 rounded-xl p-4">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-500 to-red-700 flex items-center justify-center">
                ...
                <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-[#dc2626]/20 rounded-2xl -rotate-12 animate-pulse" style={{animationDelay: '1s'}}></div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16" data-aos="fade-up">
            ...
            {/* Tuteur Plateforme */}
            <div className="bg-white p-8 rounded-3xl border-2 border-red-300 hover:border-[#dc2626] transition-all group relative overflow-hidden shadow-lg">
              <div className="absolute top-0 right-0 w-32 h-32 bg-red-50/50 rounded-full -translate-y-16 translate-x-16"></div>
              <div className="relative z-10">
                <div className="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#dc2626] transition-all">
                  <span className="text-3xl group-hover:scale-110 transition-transform">🛡️</span>
                </div>
                <div className="flex items-center gap-2 mb-4">
                  <h3 className="text-2xl font-bold text-gray-900">Tuteur Plateforme</h3>
                  <span className="px-2 py-1 bg-red-50 text-red-700 text-[8px] font-black rounded uppercase border border-red-300">Premium</span>
                </div>
                <p className="text-gray-700 mb-6 leading-relaxed">
                ...
                <div className="px-4 py-3 bg-gradient-to-r from-[#dc2626] to-red-700 rounded-xl text-center">
          ...
          <div className="text-center" data-aos="zoom-in">
            <Link 
              href="/demo"
              className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 via-[#dc2626] to-red-700 px-12 py-6 rounded-2xl text-white font-black uppercase tracking-widest hover:shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 group"
            >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="glass-card p-12 rounded-[3rem] relative overflow-hidden group" data-aos="fade-right">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#dc2626]/5 rounded-full -translate-y-16 translate-x-16"></div>
              ...
              <ul className="space-y-6 mb-12 text-gray-400">
                <li><Check className="h-4 w-4 text-[#dc2626] mr-3" /> Accès illimité</li>
                <li><Check className="h-4 w-4 text-[#dc2626] mr-3" /> Support Tuteur 24/7</li>
                <li><Check className="h-4 w-4 text-[#dc2626] mr-3" /> Profil certifié</li>
              </ul>
              <Link href="/register" className="w-full py-5 border border-[#dc2626] text-[#dc2626] rounded-2xl font-black uppercase tracking-widest hover:bg-[#dc2626] hover:text-white transition-all block text-center">S&apos;inscrire</Link>
            </div>

            {/* Frères */}
            <div className="bg-[#dc2626] p-12 rounded-[3rem] text-white shadow-[0_20px_60px_rgba(255,0,127,0.4)] transform lg:scale-105" data-aos="fade-left">
      ...
      <section className="py-32">
        <div className="max-w-5xl mx-auto px-6">
          <div className="glass-card rounded-[4rem] p-16 text-center border-t-4 border-[#dc2626]">
            <h2 className="text-4xl lg:text-5xl font-bold mb-8 italic">Votre moitié vous <span className="text-[#dc2626]">attend.</span></h2>
      ...
      <footer className="py-12 border-t border-gray-900">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-[#dc2626] rounded flex items-center justify-center text-white font-black text-sm">Z</div>
